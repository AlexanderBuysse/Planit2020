...
class Controller
{
  ...
  public function render()
  {
    ...
    $this->set('js', '<script src="http://localhost:8901/script.js"></script>'); // webpack dev server
    // NEW : CSS
    ...
    $this->renderInLayout();
    if (!empty($_SESSION['crime'])) $this->set('crime', $_SESSION['crime']);
    if (!empty($_SESSION['suplies'])) $this->set('suplies', $_SESSION['suplies']);
